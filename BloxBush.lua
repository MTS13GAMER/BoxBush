print("✅ verificação Passada Loading BloxBush...")
...
local Update = (loadstring(Game:HttpGet("https://raw.githubusercontent.com/MTS13GAMER/BoxBush/refs/heads/main/BloxBushLibaryUi.lua")))();
...
MainTab:Button("Discord Link", function()
	setclipboard("https://discord.gg/kdeBBmWeGt");
	Update:Notify("Copied!", 3);
end);
MainTab:Button("Info....", function()
	Update:Notify("A Libary/Ui Utilizado Foi A do Rtao_dev Obrigado Por Usar Nosso Script.", 5);
end);
